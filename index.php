...
$appConfig = [
    ...
    'webSocketUrl' => env('PLAYER_WS_URL', ''),
    'webSocketPort' => (int) env('PLAYER_WS_PORT', 8080),
    'playerControlUrl' => env('PLAYER_BROWSER_CONTROL_URL', ''),
    'showWebErrors' => filter_var(env('WEB_SHOW_ERRORS', 'true'), FILTER_VALIDATE_BOOLEAN),
];
?>
<!DOCTYPE html>
<html lang="ru">
...
<body>
    <div class="content">
        <div class="musicConts">
            ...
            <div class="btns">
                <button class="prev" type="button" aria-label="Previous track">
                    <img src="./style/icons/forward.png" alt="">
                </button>
                <button class="playing" type="button" aria-label="Play or pause">
                    <img src="./style/icons/pause.png" alt="">
                </button>
                <button class="next" type="button" aria-label="Next track">
                    <img src="./style/icons/forward.png" alt="">
                </button>
            </div>
        </div>
    ...
    <div id="web-errors" class="web-errors" aria-live="polite" aria-atomic="false"></div>
